...
resource "aws_instance" "bastion_server" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo DEBIAN_FRONTEND=noninteractive apt-get -y install pipenv",
      ...
      "sudo DEBIAN_FRONTEND=noninteractive apt --yes install ansible",
      "sudo pip3 install boto3",
      "sudo pip3 install ansible",
      "sudo DEBIAN_FRONTEND=noninteractive apt --yes install unzip",
